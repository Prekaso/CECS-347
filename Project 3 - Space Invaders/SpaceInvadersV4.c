// SpaceInvadersV3.c
// Documentation
// CECS347 Project 3 - Space Invader Game
// Description: Interface between Nokia5110 LCD, Potentiometer,
//							on board buttons, using PLL, SysTick timer 
//							interrupt, edge-triggered interrupts, SSI, and 
//							on board ADC.
// Student Name: Dylan Dang, Hoang Nguyen
...
int main(void){
  ...
  while(1){
    ...
    //Delay_50ms(18);                     // delay ~0.5 sec at 80 MHz
  }
}
